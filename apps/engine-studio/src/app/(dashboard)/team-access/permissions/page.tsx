    ...
    permissions: [
      {
        ...
        name: "페르소나 조회",
        code: "persona:read",
        description: "페르소나 목록 및 상세 정보 조회",
        category: "페르소나 관리",
      },
      {
        id: "p-002",
      ...
      },
      {
        ...
        name: "페르소나 배포",
        code: "persona:deploy",
        description: "페르소나를 프로덕션에 배포",
        category: "페르소나 관리",
      },
      {
        id: "p-006",
        name: "인큐베이터 사용",
        code: "persona:incubator",
        description: "AI 인큐베이터로 페르소나 생성",
        category: "페르소나 관리",
      },
    ],
  },
  {
    ...
    permissions: [
      ...
      },
      {
        ...
        description: "새 인사이트 분석 실행",
        category: "사용자 인사이트",
      },
      {
        id: "p-013",
        name: "콜드스타트 관리",
        code: "insight:coldstart",
        description: "콜드스타트 설정 관리",
        category: "사용자 인사이트",
      },
      {
        id: "p-014",
        name: "심리분석 조회",
        code: "insight:psychometric",
        description: "심리분석 결과 조회",
        category: "사용자 인사이트",
      },
      {
        id: "p-015",
        name: "아키타입 관리",
        code: "insight:archetype",
        description: "아키타입 설정 관리",
        category: "사용자 인사이트",
      },
    ],
  },
    ...
    permissions: [
      {
        id: "p-021",
        name: "매칭 시뮬레이션",
        code: "matching:simulate",
        description: "매칭 시뮬레이션 실행",
        category: "매칭 랩",
      },
      {
        id: "p-022",
        name: "알고리즘 튜닝",
        code: "matching:tune",
        description: "매칭 알고리즘 파라미터 조정",
        category: "매칭 랩",
      },
      {
        id: "p-023",
        name: "성능 분석",
        code: "matching:performance",
        description: "매칭 성능 데이터 조회",
        category: "매칭 랩",
      },
    ],
  },
    ...
    <div className="flex flex-col gap-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">역할 기반 접근 제어(RBAC) 설정</p>
        </div>
                            ...
                            <Badge variant="secondary" className="ml-2">
                              {
                                group.permissions.filter((p) =>
                                  newRoleForm.permissions.includes(p.code)
                                ).length
                              }
