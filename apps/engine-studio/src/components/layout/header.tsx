...
const SEARCH_ITEMS: SearchItem[] = [
  ...
  { label: "Psychometric Model", href: "/user-insight/psychometric", section: "User Insight" },
  ...
  { label: "Activity Dashboard", href: "/persona-world-admin/activity", section: "PW Admin" },
