          ...
          return (
            <div key={dim} className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent side="right" className="max-w-xs">
                      ...
                      <p className="mt-1 text-xs">{label.description}</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
              ...
              <div className="flex items-center gap-4">
                <span className="text-muted-foreground w-16 text-right text-xs">{label.low}</span>
                <Slider
                  value={[value[dim] * 100]}
                  ...
                  className="flex-1"
                />
                <span className="text-muted-foreground w-16 text-xs">{label.high}</span>
              </div>
            </div>
          )
        })}
