...
\`\`\`json
{
  "name": "풀네임 (성+이름). 다양한 국적 가능 (예: '김현서', 'Sophia Chen', 'Yuki Tanaka', 'Amir Patel')",
...
1. name은 풀네임(성+이름)으로, 다양한 국적/문화 배경의 이름을 사용 (한국, 일본, 중국, 서양, 중동, 남아시아, 아프리카 등). 한국 이름은 '김현서', '박지원' 형태, 외국 이름은 'Sophia Chen', 'Yuki Tanaka' 형태
