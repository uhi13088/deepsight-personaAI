...
\`\`\`json
{
  "name": "English full name (diverse nationalities, e.g., 'Sophia Chen', 'Yuki Tanaka', 'Amir Patel', 'Elena Volkov')",
...
1. name은 반드시 영어로 된 풀네임(이름+성)으로, 다양한 국적/문화 배경 사용 (동아시아, 서양, 중동, 남아시아, 아프리카 등). 예: 'Sophia Chen', 'Yuki Tanaka', 'Amir Patel', 'Elena Volkov'. 한국어 이름 금지
1-1. handle은 반드시 영어로, 이 페르소나의 개성/분위기를 반영한 창의적인 SNS 핸들. @로 시작, 소문자+밑줄, 3~20자. 예: '@midnight_critic', '@velvet_lens'
