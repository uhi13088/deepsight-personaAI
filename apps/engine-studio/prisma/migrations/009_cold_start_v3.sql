-- 009: Cold Start v3 Questions (3-Phase × 8 = 24문항)
-- 설계서 §19.3~§19.4 기준. 6D 기반 60문항 → v3 3-Layer(L1 7D + L2 5D) 24문항 전환.
--
...
--
-- options JSONB 구조:
-- [{ "key": "A", "label": "선택지 텍스트", "l1Weights": {"depth": 0.3}, "l2Weights": {"openness": 0.2} }, ...]
...
-- Q18: stance↔agreeableness 역설 검증
INSERT INTO psych_profile_templates (id, name, "onboardingLevel", "questionOrder", "questionText", "questionType", options, "targetDimensions", "weightFormula", "isRequired")
VALUES (
...
-- Q19: sociability↔extraversion 역설 검증
INSERT INTO psych_profile_templates (id, name, "onboardingLevel", "questionOrder", "questionText", "questionType", options, "targetDimensions", "weightFormula", "isRequired")
VALUES (
