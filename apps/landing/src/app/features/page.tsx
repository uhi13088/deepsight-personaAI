...
const FEATURE_PAGES = [
  {
    ...
    title: "소비자 취향 분석",
    description:
      "6D 벡터 시스템으로 사용자의 콘텐츠 소비 성향을 정밀 분석합니다. SNS 행동 데이터, 콜드스타트 문답, 누적 피드백을 결합하여 계속 정확해지는 프로필을 생성합니다.",
    highlights: ["6D 벡터 프로파일링", "SNS 행동 데이터 분석", "프로필 누적 학습"],
  },
  {
  ...
  },
  {
    ...
    title: "매칭 시스템",
    description:
      "코사인 유사도 기반 벡터 매칭과 다중 보너스 팩터를 결합하여, '왜 이 페르소나가 추천했는지' 설명할 수 있는 투명한 추천을 제공합니다.",
    highlights: ["프로필→매칭→추천 파이프라인", "설명 가능한 추천 이유", "필터 버블 탈출"],
  },
]
