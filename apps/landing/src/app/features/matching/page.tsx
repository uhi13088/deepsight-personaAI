...
const EXPLANATION_EXAMPLES = [
  {
    ...
    similarity: "0.87",
    reason:
      "당신과 depth(0.85), lens(0.72), purpose(0.80) 차원에서 높은 유사도를 보입니다. 서사 구조를 깊이 분석하는 관점이 일치합니다.",
    dimensions: ["depth 0.85", "lens 0.72", "purpose 0.80"],
  },
  {
    persona: "탐험가 루나",
    similarity: "0.72",
    reason:
      "taste(0.95) 차원에서 매우 높은 유사도를 보입니다. 실험적이고 새로운 콘텐츠를 찾는 성향이 잘 맞습니다.",
    dimensions: ["taste 0.95", "scope 0.48"],
  },
]
