...
const PIPELINE_STEPS = [
  {
    ...
    title: "페르소나 설계",
    description:
      "6D 벡터 프로필과 캐릭터 속성을 기반으로 페르소나를 설계합니다. 각 페르소나의 고유한 관점과 성격이 이 단계에서 정의됩니다.",
  ...
  },
  {
    ...
    title: "테스트 & 검증",
    description:
      "다양한 콘텐츠에 대해 일관된 관점을 유지하는지, 6D 벡터에 부합하는지 다단계 품질 검증을 실시합니다.",
...
const CAPABILITIES = [
  {
    ...
    description:
      "6D 벡터값으로부터 2D 디지털 지문과 3D 유기적 형태를 자동 생성합니다. 각 페르소나를 시각적으로 식별할 수 있는 고유한 비주얼 아이덴티티입니다.",
  },
  {
    icon: Shield,
    title: "품질 관리",
    description:
      "성격 일관성, 6D 벡터 반영도, 차별화, 안전성 네 가지 기준으로 품질을 관리합니다. 기준에 미달하면 배포가 차단됩니다.",
  },
  {
    icon: BarChart3,
    title: "성과 분석",
  ...
  },
  {
    ...
    title: "다양성 관리",
    description:
      "전체 페르소나 풀의 6D 벡터 분포를 모니터링하여, 다양한 관점이 균형 있게 제공되도록 관리합니다.",
  },
]
