    ...
    items: [
      {
        ...
        answer:
          "DeepSight는 AI 페르소나 기반의 콘텐츠 추천 B2B SaaS 플랫폼입니다. 사용자의 콘텐츠 소비 성향을 3-Layer 벡터(L1 Content DNA 7D + Sociability, L2 OCEAN 5D, L3 Narrative Drive 4D)로 분석하고, AI 페르소나가 사용자의 관점에서 콘텐츠를 추천합니다. 기존 추천 시스템의 '블랙박스' 문제를 해결하여, 사용자가 '왜 이 콘텐츠가 추천됐는지' 이해할 수 있는 설명 가능한 추천을 제공합니다.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "두 가지 방법으로 측정됩니다. 첫째, 3-Phase 24문항 하이브리드 시나리오를 통해 각 레이어별로 체계적으로 프로필을 생성합니다. 둘째, 사용자의 콘텐츠 소비 행동(클릭, 체류시간, 반응 등)을 분석하여 벡터값을 지속적으로 보정합니다. 두 방법을 결합하면 더 정확한 프로필을 얻을 수 있습니다.",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "세 가지 방법을 제공합니다. (1) 문답 방식: 3-Phase 24문항 하이브리드 시나리오로 3-Layer 벡터를 빠르게 생성합니다. Phase별로 L1 Content DNA, L2 OCEAN, L3 Narrative Drive를 체계적으로 측정합니다. (2) SNS 연동: 사용자의 소셜 미디어 데이터(좋아요, 팔로우, 관심사 등)를 분석하여 3-Layer 벡터를 추론합니다. 질문 없이도 프로필을 생성할 수 있습니다. (3) 문답 + SNS 병행: 두 데이터 소스를 결합하여 더 높은 정확도의 프로필을 생성합니다.",
      },
      {
    ...
    items: [
      {
        ...
        answer:
          "3-Tier 매칭(Basic/Advanced/Exploration) 시스템으로 사용자와 페르소나를 연결합니다. 사용자의 3-Layer 벡터와 페르소나의 3-Layer 벡터를 레이어별로 분석하고, 세대, 지역, 표현 온도, 전문성 등의 보너스 팩터를 적용하여 최종 매칭 점수를 산출합니다. 확신도가 높은 차원은 매칭에서 더 큰 가중치를 받습니다.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "사용자와 완전히 동일한 성향의 페르소나만 매칭하지 않습니다. 다양한 성향의 페르소나가 서로 다른 관점에서 콘텐츠를 추천하여, 사용자가 자연스럽게 새로운 콘텐츠를 발견할 수 있도록 합니다. Extended Paradox Score와 교차축 83축을 활용하여 추천의 폭을 조절합니다.",
      },
    ],
  },
  {
