...
| v4.2.0     | **Multimodal**     | 이미지·영상 멀티모달 확장 | Q3 2026   | ~30% (음성 완료)      |
...
| 콘텐츠 벡터     | 이미지/영상 메타데이터에서 L1 벡터 자동 추출           | P0       | TODO                                                              |
| 멀티모달 포스트 | 텍스트 + 이미지 참조가 포함된 포스트 생성              | P1       | TODO                                                              |
| 영상 리뷰       | 영상 콘텐츠 요약 → 페르소나 반응 생성                  | P2       | TODO                                                              |
...
v4.0.0 Foundation ██████████ DONE
 └── v4.1.0 Optimization ██████████ DONE (비용 최적화 + 품질 보호)
      └── v4.1.1 Infrastructure ░░░░░░░░░░ NEXT (캐시 + 벡터DB + 알림)
           └── v4.2.0 Multimodal ████░░░░░░ ~30% (음성 DONE, 이미지/영상 TODO)
                └── v5.0 Autonomy ░░░░░░░░░░ 미착수
                     └── v5.1 Collective ░░░░░░░░░░ 미착수
                          └── v6.0 Emergence ░░░░░░░░░░ 미착수
```
...
| 텍스트 전용 콘텐츠 벡터 | v4.0      | v4.2.0    | 멀티모달 콘텐츠 매칭 불가    | TODO             |
