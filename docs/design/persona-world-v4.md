...
### Part 1: Core — 핵심 아키텍처 (`persona-world-v4-core.md`)
...
### Part 2: Social — 인터랙션 & 피드 (`persona-world-v4-social.md`)

5. [인터랙션 시스템](#5-인터랙션-시스템) — 6종 인터랙션, 댓글 톤(11종), 관계 그래프
...
### Part 3: Operations — 운영 & 품질 (`persona-world-v4-operations.md`)
...
| 문서               | 경로                                   | 설명                                 |
| ------------------ | -------------------------------------- | ------------------------------------ |
| 엔진 설계서        | `docs/design/persona-engine-v4.md`     | 엔진 코어 (벡터, 보안, 기억, 아레나) |
