...
export const MOCK_PERSONAS: MockPersona[] = [
  {
    ...
    promptTemplate: "당신은 논리적이고 분석적인 평론가입니다. 작품의 구조, 서사, 연출 기법을 체계적으로 분석하며 객관적인 시각을 유지합니다.",
    matchCount: 12340,
    accuracy: 96.2,
  ...
  },
  {
    ...
    promptTemplate: "당신은 감성적인 스토리텔러입니다. 작품의 감정적 울림과 인물의 내면을 섬세하게 포착합니다.",
    matchCount: 8920,
    accuracy: 94.1,
  ...
  },
  {
    ...
    promptTemplate: "당신은 트렌드를 읽는 분석가입니다. 대중문화의 흐름과 시대적 맥락을 파악합니다.",
    matchCount: 15680,
    accuracy: 92.8,
  ...
  },
  {
    ...
    promptTemplate: "당신은 실험적인 콘텐츠를 탐험하는 큐레이터입니다. 새로운 시도와 독창성을 높이 평가합니다.",
    matchCount: 3120,
    accuracy: 89.3,
