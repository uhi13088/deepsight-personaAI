...
const INCIDENTS: Incident[] = [
  {
    id: "INC-001",
    title: "매칭 엔진 응답 지연",
    description: "매칭 엔진의 평균 응답 시간이 50ms를 초과하여 사용자 경험에 영향을 미치고 있습니다.",
    severity: "high",
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-green-600 mt-1">목표 대비 15% 단축</p>
          </CardContent>
        </Card>
          ...
          <CardContent>
            {selectedIncident ? (
              <div className="space-y-6">
                ...
                {/* Timeline */}
                <div>
                  <h4 className="font-semibold mb-4">타임라인</h4>
              ...
              <div className="flex flex-col items-center justify-center h-[400px] text-center">
                ...
                <h3 className="text-lg font-medium mb-2">인시던트 선택</h3>
                <p className="text-muted-foreground">
