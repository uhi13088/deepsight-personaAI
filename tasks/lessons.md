...
- [2026-03-10] **⭐ DeepSight 벡터 시스템은 3-Layer 106D+. 절대로 "16D"로 축소 표기하지 말 것.** 16D(L1 7 + L2 5 + L3 4)는 정량 벡터의 기본 축일 뿐이고, 정성 4차원(Backstory/Voice/Pressure/Zeitgeist) + Cross-Layer 83축 + 다이내믹스를 포함한 전체 시스템은 106D+. UI 텍스트, 주석, 테스트 설명 등 어디서든 시스템을 "16D"라고 쓰면 제품의 핵심 차별점이 사라짐. 표기 기준: "3-Layer Orthogonal Vector System (106D+)"
